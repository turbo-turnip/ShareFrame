...
const VersionControl = ({ project, error }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const request = await fetch(`https://api.github.com/repos/${project.repo_username}/${project.repo_title}`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="project-version-control">
